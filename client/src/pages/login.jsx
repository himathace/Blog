        ...
        <div className="flex min-h-screen justify-center items-center bg-[#f5f5f5]">
            <div className=" w-96 rounded-xl p-10 bg-white shadow-xl">
                ...
                <div className="mb-6">
                    ...
                    <input type="email" id="email" placeholder="Enter your email" className="w-full rounded-md h-10 p-4 border border-[#e1e1e1] focus:outline-none focus:ring-2 focus:ring-blue-600 " onChange={(e)=>{
                        setusername(e.target.value)
                    }} required></input>
                </div>
                <div className="mb-4">
                    <label for="password" className="block mb-3 text-sm font-semibold">Password</label>
                    <input type="password" id="password" placeholder="••••••••" className="w-full rounded-md h-10 p-4 border border-[#e1e1e1]  focus:outline-none focus:ring-2 focus:ring-blue-600" onChange={(e)=>{
                ...
                <div className="mb-4">
                    <button className="w-full h-12 bg-[#3b82f6] rounded-lg text-white font-medium hover:bg-[#2563eb]" onClick={letuserlogin}>Sign in</button> 
                </div>
                ...
                <div className="flex justify-center text-sm text-[#666] gap-x-2">
                    Don't have an account? <a href="#" className="text-[#3b82f6] font-semibold"> Sign up</a>
                </div>
